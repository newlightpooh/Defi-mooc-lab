...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    function uniswapV2Call(
        ...
        uint debtToCover = amount1; // USDT ที่นำไป liquidate
        ...
        // 2.3 swap WBTC for other things(ETH) or repay directly
        
        console.log("--------swap WBTC for ETH--------");
        
        uint swap_WBTC_for_ETH = WBTC.balanceOf(address(this)); // check WBTC ที่เหลืออยู่
        console.log("WBTC remain: ", swap_WBTC_for_ETH);
        WBTC.transfer(address(uniswapV2Pair_WBTC_WETH), swap_WBTC_for_ETH); 
        uint amountOut_WETH = getAmountOut(swap_WBTC_for_ETH, reserve_WBTC_Pool2, reserve_WETH_Pool2);  // คำนวณ WETH ที่จะได้
